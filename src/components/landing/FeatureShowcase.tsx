    ...
    <section className="py-24 px-4 md:px-8 bg-background relative border-t border-slate-900/5">
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full">
          ...
          <Card className="md:col-span-8 glass-card group hover:border-[rgba(255,255,255,0.3)] transition-colors">
            <CardHeader className="flex flex-row justify-between items-start">
              <div>
                <Badge variant="outline" className="mb-2 text-slate-500 border-slate-900/10 bg-white/50">Communication Core</Badge>
            ...
            <CardContent>
              <CardDescription className="readable-muted text-base max-w-md">
              ...
              <div className="mt-8 h-32 rounded-lg bg-slate-100 border border-slate-900/5 flex items-center justify-center overflow-hidden relative">
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/10 to-transparent animate-pulse" />
                <AudioWaveform className="w-16 h-16 text-slate-300" />
              </div>
            </CardContent>
          </Card>
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            <Card className="flex-1 glass-card group hover:border-[rgba(255,255,255,0.3)] transition-colors">
              <CardHeader>
                <Badge variant="outline" className="w-fit mb-2 text-slate-500 border-slate-900/10 bg-white/50">Intelligence</Badge>
          ...
          <Card className="md:col-span-12 glass-card group hover:border-[rgba(255,255,255,0.3)] transition-colors">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-6 md:p-8 md:border-r border-slate-900/5">
                <Badge variant="outline" className="mb-2 text-slate-500 border-slate-900/10 bg-white/50">Platform Layer</Badge>
