      ...
      */}
      ...
      <div className="relative z-10 flex-1 flex flex-col lg:flex-row items-center justify-center px-4 md:px-8 max-w-[1400px] mx-auto w-full pointer-events-none gap-12 lg:gap-8">
        ...
        <div className="w-full max-w-2xl text-center lg:text-left pointer-events-auto flex flex-col items-center lg:items-start pt-20 lg:pt-0">
          ...
          <p className="text-lg md:text-xl font-sans font-light text-muted-foreground mb-10 max-w-lg lg:max-w-xl leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start w-full sm:w-auto">
            <Button size="lg" className="rounded-full px-8 h-12 text-sm font-semibold shadow-xl">
              Try WarpTalk Free
            </Button>
            <Button size="lg" variant="outline" className="rounded-full px-8 h-12 text-sm font-semibold bg-background/50 backdrop-blur-md border-white/20 text-foreground hover:bg-white/10 hover:text-foreground">
              Book Demo
            </Button>
          </div>
        </div>
        ...
        <div className="w-full lg:flex-1 flex justify-center lg:justify-end pointer-events-auto">
          <motion.div
            ...
            className="w-full max-w-[420px] rounded-2xl border border-white/15 bg-black/40 backdrop-blur-2xl p-6 shadow-2xl flex flex-col gap-4"
          >
            {/* Header: Lang to Lang */}
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              <div className="flex items-center gap-3">
                <div className="flex flex-col">
                  <span className="text-xs text-white/50 font-medium">Source</span>
                ...
                <div className="flex flex-col">
                  <span className="text-xs text-white/50 font-medium">Target</span>
                  <span className="text-sm text-white font-semibold">Japanese</span>
                </div>
              </div>
              <div className="px-2 py-1 rounded bg-white/10 text-[10px] uppercase tracking-wider text-white/70 font-bold border border-white/5">
                Near Real-Time
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-xs text-white/50 font-medium">Alex (Speaker)</span>
              ...
              <div className="flex items-start gap-3 mt-2">
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-xs text-white/50 font-medium flex items-center gap-2">
                    Translated & Cloned Voice
                    <span className="px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-400 text-[9px] uppercase font-bold tracking-wider">Active</span>
                  </span>
                  <p className="text-sm text-white/90 leading-snug">
