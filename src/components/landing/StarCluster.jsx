...
Command: npx gltfjsx@6.5.3 ./public/models/star_cluster_-_15k_stars_model.glb --keepnames -o ./src/components/landing/StarCluster.jsx 
...
export function Model(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/star_cluster_-_15k_stars_model.glb')
